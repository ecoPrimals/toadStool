...
- **Tests**: 22,440+ (7,842+ lib-only, 0 failures, unlimited parallelism)
...
- **BTSP**: Phase 3 encrypted channel (ChaCha20-Poly1305, S215) + 13/13 converged JSON-line relay + NDJSON post-handshake (primalSpring Phase 45c); PG-46 resolved (connection-reused handshake, S214)
