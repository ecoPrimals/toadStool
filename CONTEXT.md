...
- **Wave 8 Compute Trio** (S235–S263): `compute.dispatch.submit` trio-standard IPC contract. Phase A–D complete. **128 JSON-RPC methods** (direct, including bare `"health"` S315; S372: 14 missing science.*/inference.* entries added; S380: `compute.silicon_ledger.report` / `.query`).
