...
- **Tests**: 22,423 (7,842+ lib-only, 0 failures, unlimited parallelism)
...
- **BTSP**: 13/13 converged — JSON-line relay + NDJSON post-handshake (primalSpring Phase 45c); PG-46 resolved (connection-reused handshake, S214)
