...
- **Wave 8 Compute Trio** (S235–S263): `compute.dispatch.submit` trio-standard IPC contract. Phase A–D complete. **126 JSON-RPC methods** (direct, including bare `"health"` S315; S372: 14 missing science.*/inference.* entries added).
...
- **Tests**: 8,447+ (lib-only, 0 failures, unlimited parallelism)
