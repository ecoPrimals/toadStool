...
**Updated Aug 17 — S382** (vendor tool excision + test recovery; S381: deep debt + overstep cleanup). **8,521 lib tests, 0 failures** — `--lib` only; ~13,102 integration test fns are never run by CI (D-TEST-COMPILE).
