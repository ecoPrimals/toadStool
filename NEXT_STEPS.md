...
**~85%+ estimated line coverage** (lib-only). **9,171+ lib tests** (0 failures). Target 90%.
...
| Item | Status |
|------|--------|
| Coverage push 85%→90% | **Active sprint** — S294–S327 expanded to 9,171+ lib; remaining gap in VFIO/DRM/GPU hardware paths |
...
- [ ] **Test coverage target 90%** -- 23,000+ tests (9,171+ lib-only); ~85%+ line; +174 tests S294–S298 targeting non-VFIO gaps; remaining gap in hardware-dependent paths; push to 90% ongoing
