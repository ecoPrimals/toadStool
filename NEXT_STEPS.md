...
**Latest**: S319 — Dead protocol purge: gRPC coordination + OpenCL GPU framework deleted entirely (60 files, −458 lines). S318 — Router split + `PRIMAL_SOCKET` purge + lint hygiene. S317 — 6 deprecated ctors/methods deleted. S316 — File splits. S315 — Wave 113 compliance.
