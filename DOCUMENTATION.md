...
- **668 WGSL shaders** — zero orphans, 26 DF64 files, **zero f32-only**. All f64 canonical.
- **2,753+ barracuda tests** + 4,700+ workspace lib tests | all quality gates green (0 warnings)
