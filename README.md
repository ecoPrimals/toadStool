...
**Sovereign Compute Hardware** | Pure Rust | ecoBin | Aug 2026 | S370 | v0.2.0
...
| `cargo check` WASM Tier 3 (compute subset) | **10/10 crates** on `wasm32-unknown-unknown` + `wasm32-wasip1` |
