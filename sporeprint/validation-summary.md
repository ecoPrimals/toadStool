...
description = "Sovereign compute hardware primal — 9,122+ lib tests, 85 JSON-RPC methods, 64 crates, VFIO GPU init pipeline, v0.2.0"
date = 2026-05-20
...
- **Lib tests**: 9,122+ (0 failures, unlimited parallelism)
