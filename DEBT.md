...
| D-COV | Test coverage → 90% | Medium | **~85%+ line coverage** (llvm-cov). **23,000+ tests** (9,074+ lib-only, S323+). Target 90%. Remaining gaps: hardware-dependent paths (VFIO, DRM, V4L2, akida), specialty runtimes. |
