...
| D-COV | Test coverage → 90% | Medium | **~85%+ line coverage** (llvm-cov). **23,000+ tests** (9,095+ lib-only, S324+). Target 90%. Remaining gaps: hardware-dependent paths (VFIO, DRM, V4L2, akida), specialty runtimes. |
