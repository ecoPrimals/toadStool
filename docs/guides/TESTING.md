...
|--------|--------|---------|
| **Workspace Tests** | **11,956+ (default features)** | 0 failures, 222 intentional GPU ignores |
| **Line Coverage** | **~85%** | ~182K production lines. Gap: hardware-dependent code (V4L2/VFIO/neuromorphic) |
