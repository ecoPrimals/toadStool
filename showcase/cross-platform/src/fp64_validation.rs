...
fn test_accumulation_precision(ctx: &GpuContext) {
    ...
    println!(
        ...
        cpu_naive_f64,
        (cpu_naive_f64 - cpu_kahan_f64).abs()
    );
    println!(
        "    CPU naive f32:  {:.15}  (error: {:.2e})",
        cpu_naive_f32,
        (cpu_naive_f32 as f64 - cpu_kahan_f64).abs()
    );
    ...
    if ctx.has_f64 {
        ...
        println!(
            "    GPU Kahan f64:  {:.15}  (error: {:.2e})",
            gpu_kahan_f64,
            (gpu_kahan_f64 - cpu_kahan_f64).abs()
        );
        println!(
            "    GPU Kahan f32:  {:.15}  (error: {:.2e})",
            gpu_kahan_f32,
            (gpu_kahan_f32 as f64 - cpu_kahan_f64).abs()
        );
