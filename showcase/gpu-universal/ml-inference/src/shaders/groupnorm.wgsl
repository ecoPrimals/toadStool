// GroupNorm: Group normalization (modern alternative to BatchNorm)
...
@group(0) @binding(1) var<storage, read> gamma: array<f32>;  // Scale parameter (per channel)
@group(0) @binding(2) var<storage, read> beta: array<f32>;   // Shift parameter (per channel)
@group(0) @binding(3) var<storage, read_write> output: array<f32>;
@group(0) @binding(4) var<storage, read_write> stats: array<f32>;  // Group statistics (mean, var)
