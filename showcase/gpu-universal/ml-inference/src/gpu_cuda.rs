...
fn main() -> Result<()> {
    ...
    #[cfg(feature = "cuda")]
    {
        ...
        println!("Running batched inference ({} batches of {})...", num_batches, batch_size);
        ...
        let min_latency = batch_latencies.iter().cloned().fold(f64::INFINITY, f64::min) / batch_size as f64;
        let max_latency = batch_latencies.iter().cloned().fold(0.0_f64, f64::max) / batch_size as f64;
