...
fn main() -> Result<()> {
    ...
    let files = [
        ("train-images-idx3-ubyte.gz", format!("{}/train-images-idx3-ubyte.gz", base_url)),
        ("train-labels-idx1-ubyte.gz", format!("{}/train-labels-idx1-ubyte.gz", base_url)),
        ("t10k-images-idx3-ubyte.gz", format!("{}/t10k-images-idx3-ubyte.gz", base_url)),
        ("t10k-labels-idx1-ubyte.gz", format!("{}/t10k-labels-idx1-ubyte.gz", base_url)),
    ];
