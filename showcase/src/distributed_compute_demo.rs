...
async fn main() -> Result<()> {
    ...
    println!("{}", "This demo shows ToadStool's REAL distributed compute capabilities:".bright_blue());
...
fn print_header() {
    println!();
    println!("{}", "╔════════════════════════════════════════════════════════════╗".bright_cyan());
    println!("{}", "║    🍄 ToadStool Distributed Compute Demonstration        ║".bright_cyan());
    println!("{}", "║         Real Subtask Spawning & Parallel Execution       ║".bright_cyan());
    println!("{}", "╚════════════════════════════════════════════════════════════╝".bright_cyan());
    println!();
}
...
fn print_footer() {
    ...
    println!("{}", "║            🎉 DISTRIBUTED DEMO COMPLETE! 🎉              ║".bright_green());
    println!("{}", "╚════════════════════════════════════════════════════════════╝".bright_green());
    println!();
    ...
    println!();
    println!("{}", "🚀 This is REAL distributed computing, not simulation!".bright_magenta().bold());
    println!();
}
...
async fn demo_single_task(orchestrator: &RuntimeOrchestrator) -> Result<()> {
    println!("{}", "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━".bright_cyan());
    println!("{}", "Demo 1: Baseline - Single Task Execution".bright_cyan());
    println!("{}", "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━".bright_cyan());
    println!();
...
async fn demo_distributed_execution(orchestrator: &RuntimeOrchestrator) -> Result<()> {
    ...
    println!("{}", "Demo 2: Distributed Execution - Multiple Subtasks".bright_magenta());
    println!("{}", "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━".bright_magenta());
    println!();
    ...
    for i in 0..num_subtasks {
        ...
        println!("  🚀 Spawning subtask {} (items {}-{})", subtask_id, start_item, end_item);
    ...
    println!("  Successful:            {}", results.iter().filter(|(_, r, _)| r.output.exit_code == Some(0)).count());
    println!("  Failed:                {}", results.iter().filter(|(_, r, _)| r.output.exit_code != Some(0)).count());
    println!("  Total execution time:  {:?}", total_duration);
    println!();
    
    let avg_subtask_time: Duration = results.iter()
        .map(|(_, _, d)| *d)
...
echo ""
"#,
        subtask_id, total_subtasks, num_items,
        subtask_id, num_items,
        num_items, num_items,
        subtask_id, num_items
    );
