...
//! NVVM device poisoning defense.
//!
//! Absorbed from hotSpring v0.6.25 handoff: proprietary NVIDIA drivers may
//! poison the device when compiling NVVM kernels that use DF64/F64Precise
//! transcendentals (exp, log). NVK/Mesa and AMD radv handle all tiers correctly.
//!
