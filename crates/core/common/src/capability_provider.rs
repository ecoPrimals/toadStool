...
impl CapabilityProvider {
    ...
    pub async fn discover(capability: Capability) -> Result<Self> {
        ...
        let discovery_socket = std::env::var("SONGBIRD_SOCKET")
        ...
        let response = client.call("ipc.find_capability", params)
            .await
...
fn string_to_capability(s: &str) -> Capability {
    ...
    match s {
        ...
        "authentication" | "security" => Capability::Authentication(AuthCapability::TokenManagement),
