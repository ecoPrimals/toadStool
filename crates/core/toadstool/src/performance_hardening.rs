...
mod tests {
    ...
    async fn test_optimized_monitor_multiple_samples() {
        ...
        monitor
            .add_sample("workload-1", create_test_metrics(30.0, 40.0))
            .await;
        monitor
            .add_sample("workload-1", create_test_metrics(50.0, 60.0))
            .await;
        monitor
            .add_sample("workload-1", create_test_metrics(70.0, 80.0))
            .await;
    ...
    async fn test_batcher_batching() {
        ...
        let batcher = AsyncBatcher::new(config, move |items: Vec<i32>| {
