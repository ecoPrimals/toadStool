...
impl ConfigUtils {
    ...
    pub fn get_worker_threads() -> u32 {
        ...
        loader.get_u32("WORKER_THREADS", num_cpus::get() as u32)
    }
    ...
    pub fn get_cache_url() -> String {
        let loader = EnvConfigLoader::new();
        loader.get_string("CACHE_URL", "redis://localhost:6379")
    }
    ...
    pub fn get_monitoring_endpoint() -> String {
        let loader = EnvConfigLoader::new();
        loader.get_string("MONITORING_ENDPOINT", "http://localhost:9090")
    }
