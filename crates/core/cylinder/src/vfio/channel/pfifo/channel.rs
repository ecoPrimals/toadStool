...
//! PFIFO channel creation, binding, and enablement for [`super::super::VfioChannel`].
...
impl VfioChannel {
    pub(in crate::vfio::channel) fn create_with_config(
        ...
        let faults = super::super::mmu_fault::read_mmu_faults(bar0);
        super::super::mmu_fault::log_mmu_faults(&faults);
    ...
    pub(in crate::vfio::channel) fn bind_channel(&self, bar0: &MappedBar) -> DriverResult<()> {
        #[expect(
    ...
    pub(in crate::vfio::channel) fn enable_channel(&self, bar0: &MappedBar) -> DriverResult<()> {
