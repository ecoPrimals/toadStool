...
echo "  2. curl -X POST -d '{\"jsonrpc\":\"2.0\",\"method\":\"compute.hardware.observe\",\"params\":{\"trace_path\":\"'$OUTPUT_DIR'/mmiotrace_compute.txt\"},\"id\":1}' /run/toadstool.sock"
echo "  3. curl -X POST -d '{\"jsonrpc\":\"2.0\",\"method\":\"compute.hardware.distill\",\"params\":{},\"id\":2}' /run/toadstool.sock"
