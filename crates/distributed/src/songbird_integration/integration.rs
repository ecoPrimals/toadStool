...
//! Core Songbird integration implementation — constructor, receiver wiring, and tests.
...
use super::types::{
    CapacityConfig, JobReceiver, ReceiverConfig, SongbirdConnection, ToadStoolSongbirdIntegration,
};
...
mod tests {
    use super::super::types::{
        CapacityConfig, ConnectionHealth, GrpcProtocolConfig, HttpProtocolConfig,
        LocalCapacityManager, MessageQueueProtocolConfig, ProtocolConfig, ReceiverConfig,
        SongbirdConnection, SongbirdProtocol, ToadStoolSongbirdIntegration,
    };
    use super::*;
