...
/// Convert BearDog permission response to generic SecurityPermission
pub fn from_beardog_permission(
...
/// Convert generic EncryptionOptions to BearDog-specific request
pub fn to_beardog_encryption_request(
    data: &[u8],
