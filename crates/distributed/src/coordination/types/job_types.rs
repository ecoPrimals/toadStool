...
pub struct CoordinationJobRequest {
    /// Job identifier.
    pub job_id: Uuid,
...
/// Coordination job submission response.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum CoordinationJobResponse {
...
pub enum JobDistributionStrategy {
    ...
    HybridExecution,
    /// Use Coordination ecosystem for discovery and placement.
    #[serde(alias = "SongbirdEcosystem")] // legacy serde alias
...
pub struct SubTaskHandle {
    /// Subtask identifier.
    pub subtask_id: Uuid,
    /// Parent Coordination job ID.
    pub coordination_job_id: Uuid,
    /// Target node IDs.
    pub target_nodes: Vec<String>,
