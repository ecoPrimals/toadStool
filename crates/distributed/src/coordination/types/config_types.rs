...
//! Configuration types for Coordination integration
...
/// Service authentication settings (re-exported for Coordination config).
...
/// Authentication configuration for Coordination.
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CoordinationIntegrationConfig {
    /// Connection config.
    pub connection_config: CoordinationConnectionConfig,
    /// Distribution config.
    pub distribution_config: DistributionConfig,
    /// Discovery config.
    pub discovery_config: CoordinationDiscoveryConfig,
...
/// Coordination connection configuration.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CoordinationConnectionConfig {
    /// Endpoint URLs.
...
/// coordination discovery configuration.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CoordinationDiscoveryConfig {
