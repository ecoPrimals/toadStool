...
#[test]
fn test_coordination_broadcast_message_all_channel_names() {
    assert_eq!(
        CoordinationBroadcastMessage::CapabilityUpdate {
            node_id: "n".to_string(),
    ...
    assert_eq!(
        CoordinationBroadcastMessage::HealthUpdate {
            node_id: "n".to_string(),
    ...
    assert_eq!(
        CoordinationBroadcastMessage::CustomMessage {
