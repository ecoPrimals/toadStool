...
use super::helpers::sample_coordination_config;
...
#[test]
fn test_coordination_job_response_success_estimated_completion_none() {
    ...
    if let CoordinationJobResponse::Success {
...
#[test]
fn test_coordination_config_constructor() {
