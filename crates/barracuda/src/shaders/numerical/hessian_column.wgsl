...
//
// hessian_column.wgsl — Parallel central-difference Hessian column computation
//
...
@group(0) @binding(0) var<storage, read> f_pp: array<f32>;  // f(x + e_i + e_j)
@group(0) @binding(1) var<storage, read> f_pm: array<f32>;  // f(x + e_i - e_j)
@group(0) @binding(2) var<storage, read> f_mp: array<f32>;  // f(x - e_i + e_j)
@group(0) @binding(3) var<storage, read> f_mm: array<f32>;  // f(x - e_i - e_j)
@group(0) @binding(4) var<storage, read_write> hessian_col: array<f32>;
