// SearchSorted - Binary search insertion indices (GPU parallel)
...
@group(0) @binding(1) var<storage, read> sorted_array: array<f32>;  // Sorted input
@group(0) @binding(2) var<storage, read> values: array<f32>;        // Values to search for
