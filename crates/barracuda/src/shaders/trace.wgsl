// Trace - Sum of diagonal elements - Pure GPU Tree Reduction
...
@group(0) @binding(0) var<storage, read> matrix: array<f32>;         // [size, size]
@group(0) @binding(1) var<storage, read_write> output: array<f32>;   // [1] or partial results
