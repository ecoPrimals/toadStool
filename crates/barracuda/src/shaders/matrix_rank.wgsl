// Matrix Rank - Compute rank via Gaussian elimination (complete implementation)
...
@group(0) @binding(1) var<storage, read> matrix: array<f32>;        // [rows, cols]
@group(0) @binding(2) var<storage, read_write> work_matrix: array<f32>; // Working copy
