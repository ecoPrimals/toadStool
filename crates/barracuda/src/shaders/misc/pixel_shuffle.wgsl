// pixel_shuffle.wgsl - Pixel Shuffle (Depth to Space)
//
...
@group(0) @binding(0) var<storage, read> input: array<f32>;         // [B, C*r^2, H, W]
@group(0) @binding(1) var<storage, read_write> output: array<f32>;  // [B, C, H*r, W*r]
