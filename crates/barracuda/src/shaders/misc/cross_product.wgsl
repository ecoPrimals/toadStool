// cross_product.wgsl - Vector cross product
//
...
@group(0) @binding(1) var<storage, read> input_b: array<f32>;  // [N, 3]
@group(0) @binding(2) var<storage, read_write> output: array<f32>; // [N, 3]
