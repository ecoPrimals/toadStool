// kldiv_loss.wgsl - KL Divergence Loss
//
...
@group(0) @binding(0) var<storage, read> input: array<f32>;        // Log probabilities (Q)
@group(0) @binding(1) var<storage, read> target_data: array<f32>;       // True probabilities (P)
@group(0) @binding(2) var<storage, read_write> output: array<f32>; // KL divergence
