// center_loss.wgsl - Center Loss for metric learning
//
...
@group(0) @binding(0) var<storage, read> features: array<f32>;     // [batch, feature_dim]
@group(0) @binding(1) var<storage, read> centers: array<f32>;      // [num_classes, feature_dim]
