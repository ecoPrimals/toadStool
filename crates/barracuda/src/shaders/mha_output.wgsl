// Multi-Head Attention: Output Projection with Head Concatenation
...
@group(0) @binding(1) var<storage, read> weight: array<f32>;  // [D, D]
@group(0) @binding(2) var<storage, read_write> output: array<f32>; // [B, S, D]
