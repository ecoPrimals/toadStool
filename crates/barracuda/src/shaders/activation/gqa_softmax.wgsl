// Grouped Query Attention Softmax: Apply softmax to attention scores
...
@group(0) @binding(0) var<storage, read> scores: array<f32>;    // [batch, num_q_heads, seq, seq]
@group(0) @binding(1) var<storage, read_write> weights: array<f32>; // [batch, num_q_heads, seq, seq]
