// chamfer_distance.wgsl - Chamfer Distance for point clouds
//
...
@group(0) @binding(0) var<storage, read> points_x: array<f32>;     // [num_points_x, point_dim]
@group(0) @binding(1) var<storage, read> points_y: array<f32>;     // [num_points_y, point_dim]
@group(0) @binding(2) var<storage, read_write> distances: array<f32>; // [num_points_x] or [num_points_y]
