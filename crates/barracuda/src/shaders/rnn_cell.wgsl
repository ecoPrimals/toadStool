// rnn_cell.wgsl - RNN Cell (single timestep)
//
...
@group(0) @binding(1) var<storage, read> weight_ih: array<f32>;    // [hidden_size, input_size]
@group(0) @binding(2) var<storage, read> weight_hh: array<f32>;    // [hidden_size, hidden_size]
@group(0) @binding(3) var<storage, read> bias_ih: array<f32>;      // [hidden_size]
@group(0) @binding(4) var<storage, read> bias_hh: array<f32>;      // [hidden_size]
@group(0) @binding(5) var<storage, read> h_prev: array<f32>;        // [batch, hidden_size]
@group(0) @binding(6) var<storage, read_write> h_next: array<f32>; // [batch, hidden_size]
