...
@group(0) @binding(0) var<storage, read> image1: array<f32>;
@group(0) @binding(1) var<storage, read> image2: array<f32>;
@group(0) @binding(2) var<storage, read_write> window_ssim: array<f32>;
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    var sum2_sq: f32 = 0.0;
    var sum12: f32 = 0.0;
    let n = f32(params.window_size * params.window_size);
