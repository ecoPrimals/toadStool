...
@group(0) @binding(0) var<storage, read> spectrogram: array<f32>;  // [n_frames, n_freqs]
@group(0) @binding(1) var<storage, read> filterbank: array<f32>;   // [n_mels, n_freqs]
@group(0) @binding(2) var<storage, read_write> output: array<f32>; // [n_frames, n_mels]
