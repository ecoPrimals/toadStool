// Tversky Loss - Generalized Dice Loss with FP/FN weighting
...
struct Params {
    alpha: f32,              // Weight for false positives (0.0-1.0, typically 0.3-0.7)
    beta: f32,               // Weight for false negatives (0.0-1.0, typically 0.3-0.7)
