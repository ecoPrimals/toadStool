// Grouped Query Attention Matrix Multiplication: Compute QK^T scores
...
@group(0) @binding(0) var<storage, read> query: array<f32>;     // [batch, num_q_heads, seq, head_dim]
@group(0) @binding(1) var<storage, read> key: array<f32>;       // [batch, num_kv_heads, seq, head_dim]
@group(0) @binding(2) var<storage, read_write> scores: array<f32>; // [batch, num_q_heads, seq, seq]
