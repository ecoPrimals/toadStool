// circular_pad2d.wgsl - Circular/wrap padding for 2D tensors
//
...
@group(0) @binding(0) var<storage, read> input: array<f32>;     // [B, C, H_in, W_in]
@group(0) @binding(1) var<storage, read_write> output: array<f32>; // [B, C, H_out, W_out]
