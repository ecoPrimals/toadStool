// adabound.wgsl - AdaBound Optimizer
//
...
struct Params {
    ...
    epsilon: f32,
    weight_decay: f32,
    final_lr: f32,    // Final learning rate for SGD convergence
    gamma: f32,       // Rate of convergence to SGD
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let m_hat = m[idx] / (1.0 - pow(params.beta1, step_f));
    let v_hat = v[idx] / (1.0 - pow(params.beta2, step_f));
    ...
    let step_size = params.lr / (sqrt(v_hat) + params.epsilon);
