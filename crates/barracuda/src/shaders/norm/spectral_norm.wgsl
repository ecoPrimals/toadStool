// spectral_norm.wgsl - Spectral Normalization
//
...
@group(0) @binding(0) var<storage, read_write> weight: array<f32>;  // [rows, cols]
@group(0) @binding(1) var<storage, read_write> u: array<f32>;       // [rows] - left singular vector
@group(0) @binding(2) var<storage, read_write> v: array<f32>;       // [cols] - right singular vector
