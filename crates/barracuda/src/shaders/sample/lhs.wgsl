// Latin Hypercube Sampling (LHS) - GPU accelerated
...
fn rand_for_sample(sample_idx: u32, dim: u32, component: u32, base_seed: u32) -> f32 {
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let interval_width = 1.0 / f32(n_samples);
    ...
    for (var d = 0u; d < n_dims; d = d + 1u) {
        ...
        let interval_lo = f32(interval_idx) * interval_width;
