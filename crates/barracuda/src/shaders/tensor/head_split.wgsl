// head_split.wgsl — Reshape [B, S, H*D] → [B, H, S, D]
//
...
@group(0) @binding(0) var<storage, read>       input:  array<f32>;  // [B, S, H*D]
@group(0) @binding(1) var<storage, read_write> output: array<f32>;  // [B, H, S, D]
