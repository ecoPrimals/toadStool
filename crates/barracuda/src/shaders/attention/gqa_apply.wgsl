...
@group(0) @binding(0) var<storage, read> weights: array<f32>;   // [batch, num_q_heads, seq, seq]
@group(0) @binding(1) var<storage, read> value: array<f32>;     // [batch, num_kv_heads, seq, head_dim]
@group(0) @binding(2) var<storage, read_write> output: array<f32>; // [batch, num_q_heads, seq, head_dim]
