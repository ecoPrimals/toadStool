...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let out_idx = if (params.path == 0u || params.path == 2u) {
        b * params.out_channels_high * params.out_height_high * params.out_width_high +
        c_out * params.out_height_high * params.out_width_high +
        oh * params.out_width_high + ow
    } else {
        b * params.out_channels_low * params.out_height_low * params.out_width_low +
