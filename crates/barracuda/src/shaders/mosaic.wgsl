...
@group(0) @binding(0) var<storage, read> image0: array<f32>;
@group(0) @binding(1) var<storage, read> image1: array<f32>;
@group(0) @binding(2) var<storage, read> image2: array<f32>;
@group(0) @binding(3) var<storage, read> image3: array<f32>;
