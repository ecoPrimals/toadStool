...
@group(0) @binding(0) var<storage, read> input: array<f32>;         // [B, C, D, H, W]
@group(0) @binding(1) var<storage, read_write> output: array<f32>;  // [B, C, D_out, H_out, W_out]
