// weight_norm.wgsl - Weight Normalization
//
...
@group(0) @binding(0) var<storage, read> v: array<f32>;             // Direction vectors
@group(0) @binding(1) var<storage, read> g: array<f32>;             // Magnitude scalars
@group(0) @binding(2) var<storage, read_write> output: array<f32>;  // Normalized weights
