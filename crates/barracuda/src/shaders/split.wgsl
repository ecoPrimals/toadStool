// Split operation - Split tensor along a dimension (inverse of Concat)
...
@group(0) @binding(1) var<storage, read_write> output1: array<f32>;
@group(0) @binding(2) var<storage, read_write> output2: array<f32>;
