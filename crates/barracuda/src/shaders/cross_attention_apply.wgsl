...
@group(0) @binding(0) var<storage, read> weights: array<f32>; // [B, H, Dec, Enc]
@group(0) @binding(1) var<storage, read> value: array<f32>;   // [B, H, Enc, D]
@group(0) @binding(2) var<storage, read_write> output: array<f32>; // [B, H, Dec, D]
