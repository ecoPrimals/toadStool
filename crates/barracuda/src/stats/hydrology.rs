...
// ── Fused seasonal pipeline GPU (ET₀ → Kc → WB → Yield in one dispatch) ───
...
impl SeasonalPipelineF64 {
    ...
    /// Execute the fused seasonal pipeline for `n_cells` spatial cells.
    pub fn dispatch(
        &self,
        cell_weather: &[f64],
...
impl McEt0PropagateGpu {
    ...
    pub fn dispatch(
        ...
        // xoshiro128** needs 4 u32 per sample
