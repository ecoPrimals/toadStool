...
impl BesselJ1 {
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        let bind_group_layout =
            device
                ...
                .create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                    label: Some("BESSEL_J1 Bind Group Layout"),
                    entries: &[
        ...
        let bind_group = device.device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("BESSEL_J1 Bind Group"),
        ...
        let shader = device.compile_shader(Self::wgsl_shader(), Some("BESSEL_J1"));

        let pipeline_layout =
            device
                .device
                .create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                    label: Some("BESSEL_J1 Pipeline Layout"),
        ...
        let mut encoder = device
            ...
            .create_command_encoder(&wgpu::CommandEncoderDescriptor {
                label: Some("BESSEL_J1 Encoder"),
            });

        {
            let mut pass = encoder.begin_compute_pass(&wgpu::ComputePassDescriptor {
                label: Some("BESSEL_J1 Pass"),
