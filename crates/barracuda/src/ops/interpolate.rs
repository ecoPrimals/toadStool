...
pub async fn interpolate(
    ...
    let (_, _, out_h, out_w) = (output_size[0], output_size[1], output_size[2], output_size[3]);
                ...
                for ow in 0..out_w {
                    ...
                    let value = match mode {
                        ...
                        InterpolateMode::Bilinear | InterpolateMode::Trilinear => {
                            ...
                            let idx00 = batch * c * in_h * in_w + ch * in_h * in_w + ih0 * in_w + iw0;
                            let idx01 = batch * c * in_h * in_w + ch * in_h * in_w + ih0 * in_w + iw1;
                            let idx10 = batch * c * in_h * in_w + ch * in_h * in_w + ih1 * in_w + iw0;
                            let idx11 = batch * c * in_h * in_w + ch * in_h * in_w + ih1 * in_w + iw1;
                    ...
                    output[batch * c * out_h * out_w + ch * out_h * out_w + oh * out_w + ow] = value;
                }
            }
        }
    }
