//! ERFC - Complementary error function operation - Pure WGSL
//!
...
impl Erfc {
    ...
    fn wgsl_shader() -> &'static str {
        static SHADER: std::sync::LazyLock<String> =
            std::sync::LazyLock::new(|| crate::shaders::precision::downcast_f64_to_f32_with_transcendentals(include_str!("../shaders/math/erfc_f64.wgsl")));
        &SHADER
    }
