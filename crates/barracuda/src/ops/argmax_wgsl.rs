...
/// Argmax operation - Find indices of maximum values along a dimension
pub struct Argmax {
    input: Tensor,
    dim: usize,
}
...
impl Argmax {
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        let bind_group_layout = device.device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
            label: Some("Argmax Bind Group Layout"),
            entries: &[
