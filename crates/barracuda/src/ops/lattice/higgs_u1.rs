...
const HIGGS_SHADER_BODY: &str =
    include_str!("../../shaders/lattice/higgs_u1_hmc_f64.wgsl");
...
impl HiggsU1HmcForce {
    ...
    pub fn new(
        ...
        let params_data = HiggsParams {
            nt, ns, volume, _pad: 0,
            beta_pl, kappa, lambda, mu_sq, dt,
            _padf0: 0.0, _padf1: 0.0, _padf2: 0.0,
        };
    ...
    pub fn set_dt(&self, dt: f64) {
        ...
        self.device.queue.write_buffer(&self.params, offset, &dt.to_le_bytes());
    }
    ...
    pub fn half_kick(
        ...
        let bg = self.device.device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                ...
                wgpu::BindGroupEntry { binding: 1, resource: link_angles.as_entire_binding() },
                wgpu::BindGroupEntry { binding: 2, resource: higgs.as_entire_binding() },
                wgpu::BindGroupEntry { binding: 3, resource: pi_links.as_entire_binding() },
                wgpu::BindGroupEntry { binding: 4, resource: pi_higgs.as_entire_binding() },
            ],
        });
