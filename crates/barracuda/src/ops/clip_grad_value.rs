...
mod tests {
    ...
    async fn test_clip_grad_value_edge_cases() {
        ...
        let clipped = clip_grad_value(&dev.device, &dev.queue, &grads, 1.0).await.unwrap();
    ...
    async fn test_clip_grad_value_boundary() {
        ...
        let clipped = clip_grad_value(&dev.device, &dev.queue, &grads, 10.0).await.unwrap();
    ...
    async fn test_clip_grad_value_precision() {
        ...
        let clipped = clip_grad_value(&dev.device, &dev.queue, &grads, 5.0).await.unwrap();
