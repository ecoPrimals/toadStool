...
impl PairwiseDistance {
    ...
    pub fn new(input1: Tensor, input2: Tensor, p: Option<f32>, epsilon: Option<f32>) -> Result<Self> {
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        // Compile shader
        let shader_module = device.compile_shader(Self::wgsl_shader(), Some("PairwiseDistance Shader"));
...

        {
            ...
            let workgroups = (num_pairs as u32 + optimal_wg_size - 1) / optimal_wg_size;
