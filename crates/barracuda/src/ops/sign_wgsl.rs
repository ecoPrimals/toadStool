...
const SHADER_F64: &str = include_str!("../shaders/math/sign_f64.wgsl");
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        let params_buffer = device
            ...
            .create_buffer_init(&wgpu::util::BufferInitDescriptor {
                label: Some("Sign Params"),
                contents: bytemuck::cast_slice(&[params]),
                usage: wgpu::BufferUsages::UNIFORM | wgpu::BufferUsages::COPY_DST,
            });

        // Compile shader
        let shader_module = device.compile_shader(Self::wgsl_shader(), Some("Sign Shader"));
        ...
        let bind_group_layout =
            device
                ...
                .create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                    label: Some("Sign Bind Group Layout"),
                    entries: &[
        ...
        let pipeline_layout =
            device
                ...
                .create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                    label: Some("Sign Pipeline Layout"),
