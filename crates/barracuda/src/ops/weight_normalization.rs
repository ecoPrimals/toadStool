...
impl WeightNormalization {
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        // Compile shader
        let shader_module = device.compile_shader(Self::wgsl_shader(), Some("WeightNormalization Shader"));
...

        {
            ...
            compute_pass.dispatch_workgroups((num_weights as u32 + 255) / 256, 1, 1);
        }
