...
impl Argmin {
    ...
    fn wgsl_shader_reduce() -> &'static str {
        include_str!("../shaders/argmin_reduce.wgsl")
    }
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        match self.dim {
            None => {
                ...
                // Compile shader
                let shader_module = device.compile_shader(Self::wgsl_shader_reduce(), Some("Argmin Reduce Shader"));
            ...
            Some(dim) => {
                ...
                // Compile shader
                let shader_module = device.compile_shader(Self::wgsl_shader_dim(), Some("Argmin Dim Shader"));
