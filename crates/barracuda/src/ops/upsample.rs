                ...
                for ow in 0..out_w {
                    ...
                    let value = match mode {
                        ...
                        UpsampleMode::Bilinear => {
                            ...
                            let idx00 =
                                b * channels * in_h * in_w + c * in_h * in_w + ih0 * in_w + iw0;
                            let idx01 =
                                b * channels * in_h * in_w + c * in_h * in_w + ih0 * in_w + iw1;
                            let idx10 =
                                b * channels * in_h * in_w + c * in_h * in_w + ih1 * in_w + iw0;
                            let idx11 =
                                b * channels * in_h * in_w + c * in_h * in_w + ih1 * in_w + iw1;
