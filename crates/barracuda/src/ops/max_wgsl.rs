...
pub struct Max {
    input: Tensor,
    _dim: Option<usize>, // Reserved for future axis-specific max
}
...
impl Max {
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        // For now, simple max over all elements
        ...
        let params_buffer = device.device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
            label: Some("Max Params"),
            contents: bytemuck::cast_slice(&[params]),
            usage: wgpu::BufferUsages::UNIFORM | wgpu::BufferUsages::COPY_DST,
        });

        // Compile shader
        let shader_module = device.compile_shader(Self::wgsl_shader(), Some("Max Shader"));
