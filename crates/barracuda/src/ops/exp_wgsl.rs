...
impl Exp {
    ...
    fn wgsl_shader() -> &'static str {
        static SHADER: std::sync::LazyLock<String> =
            std::sync::LazyLock::new(|| crate::shaders::precision::downcast_f64_to_f32_with_transcendentals(include_str!("../shaders/math/exp_f64.wgsl")));
        &SHADER
    }
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        let params_buffer = device
            ...
            .create_buffer_init(&wgpu::util::BufferInitDescriptor {
                label: Some("Exp Params"),
                contents: bytemuck::cast_slice(&[params]),
                usage: wgpu::BufferUsages::UNIFORM | wgpu::BufferUsages::COPY_DST,
            });

        // Compile shader
        let shader_module = device.compile_shader(Self::wgsl_shader(), Some("Exp Shader"));
        ...
        let bind_group_layout =
            device
                ...
                .create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                    label: Some("Exp Bind Group Layout"),
                    entries: &[
        ...
        let pipeline_layout =
            device
                ...
                .create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                    label: Some("Exp Pipeline Layout"),
