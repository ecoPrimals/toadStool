...
impl Hardtanh {
    /// Create a new hardtanh operation
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        // Compile shader
        let shader_module = device.compile_shader(Self::wgsl_shader(), Some("Hardtanh Shader"));
        ...
        let bind_group_layout =
            device
                ...
                .create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                    label: Some("Hardtanh Bind Group Layout"),
                    entries: &[
        ...
        let bind_group = device.device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("Hardtanh Bind Group"),
        ...
        let pipeline_layout =
            device
                ...
                .create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                    label: Some("Hardtanh Pipeline Layout"),
