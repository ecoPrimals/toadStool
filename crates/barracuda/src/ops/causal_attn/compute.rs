...
impl CausalAttention {
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        ComputeDispatch::new(device, "causal_attn_matmul")
        ...
        ComputeDispatch::new(device, "causal_attn_softmax")
            .shader(Self::shader_causal_softmax(), "main")
        ...
        ComputeDispatch::new(device, "causal_attn_apply")
