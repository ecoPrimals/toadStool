...
impl MultiLabelMarginLoss {
    ...
    fn wgsl_shader() -> &'static str {
        static SHADER: std::sync::LazyLock<String> =
            std::sync::LazyLock::new(|| crate::shaders::precision::downcast_f64_to_f32_with_transcendentals(include_str!("../shaders/math/multilabel_margin_loss_f64.wgsl")));
        &SHADER
    }
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        // Compile shader
        let shader_module =
            device.compile_shader(Self::wgsl_shader(), Some("MultiLabelMarginLoss Shader"));
