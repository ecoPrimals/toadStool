...
const SHADER_F64: &str = include_str!("../shaders/activation/gelu_approximate_f64.wgsl");
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        let params_buffer = device
            ...
            .create_buffer_init(&wgpu::util::BufferInitDescriptor {
                label: Some("GeluApproximate Params"),
        ...
        // Compile shader
        let shader_module =
            device.compile_shader(Self::wgsl_shader(), Some("GeluApproximate Shader"));
        ...
        let bind_group_layout =
            device
                ...
                .create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                    label: Some("GeluApproximate Bind Group Layout"),
                    entries: &[
        ...
        let bind_group = device.device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("GeluApproximate Bind Group"),
        ...
        let pipeline_layout =
            device
                ...
                .create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                    label: Some("GeluApproximate Pipeline Layout"),
        ...
        let compute_pipeline =
            device
                ...
                .create_compute_pipeline(&wgpu::ComputePipelineDescriptor {
                    label: Some("GeluApproximate Pipeline"),
        ...
        let mut encoder = device
            ...
            .create_command_encoder(&wgpu::CommandEncoderDescriptor {
                label: Some("GeluApproximate Encoder"),
            });

        {
            let mut compute_pass = encoder.begin_compute_pass(&wgpu::ComputePassDescriptor {
                label: Some("GeluApproximate Pass"),
