...
pub(crate) const PHASE_PIPELINE_ACTIVE: u8 = 1;
pub(crate) const PHASE_MODULE_CLEANUP: u8 = 2;
...
pub(crate) struct WatchdogState {
    ...
    pub(crate) bdf: std::sync::Mutex<String>,
    pub(crate) interrupt_profile: std::sync::Mutex<InterruptProfile>,
    pub(crate) module_name: std::sync::Mutex<String>,
    pub(crate) phase: AtomicU8,
}

pub(crate) static WATCHDOG: std::sync::LazyLock<Arc<WatchdogState>> =
...
pub(crate) fn bdf_display() -> String {
    let bdf = WATCHDOG
        .bdf
        .lock()
        .unwrap_or_else(std::sync::PoisonError::into_inner);
...
pub(crate) fn module_name_display() -> String {
    let name = WATCHDOG
        .module_name
        .lock()
        .unwrap_or_else(std::sync::PoisonError::into_inner);
