...
fn main() -> Result<()> {
    ...
    println!("      Min:  {:.6}", w_in.iter().cloned().fold(f32::INFINITY, f32::min));
    println!("      Max:  {:.6}", w_in.iter().cloned().fold(f32::NEG_INFINITY, f32::max));
    ...
    println!("      Min:  {:.6}", w_res.iter().cloned().fold(f32::INFINITY, f32::min));
    println!("      Max:  {:.6}", w_res.iter().cloned().fold(f32::NEG_INFINITY, f32::max));
