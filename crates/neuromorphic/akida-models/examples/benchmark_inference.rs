...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("   ✅ {} layers, {} bytes\n", model.layer_count(), model.program_size());
    ...
    println!("\n   Min:     {:?} ({:.1}µs)", min_latency, min_latency.as_secs_f64() * 1_000_000.0);
    println!("   Avg:     {:?} ({:.1}µs)", avg_latency, avg_latency.as_secs_f64() * 1_000_000.0);
    println!("   Max:     {:?} ({:.1}µs)", max_latency, max_latency.as_secs_f64() * 1_000_000.0);
    ...
    println!("Model:");
    println!("   Size:    {} bytes ({:.2} KB)", model.program_size(), model.program_size() as f64 / 1024.0);
    ...
    println!("   Min:     {:.1}µs", min_latency.as_secs_f64() * 1_000_000.0);
    println!("   Avg:     {:.1}µs", avg_latency.as_secs_f64() * 1_000_000.0);
    println!("   Max:     {:.1}µs", max_latency.as_secs_f64() * 1_000_000.0);
    ...
    println!("   Period:  {:.1}µs per inference\n", 1_000_000.0 / throughput);
